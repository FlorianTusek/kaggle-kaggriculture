...
_FRONT_RUN_ITEMS = ("MELON", "STRAWBERRY", "MILK", "WOOL", "EGG", "WHEAT", "FERTILIZER", "TOMATO", "CARROT")
_BASE_PRICE = {"MELON": 250, "STRAWBERRY": 120, "MILK": 160, "WOOL": 200, "EGG": 50, "WHEAT": 25, "TOMATO": 60, "CARROT": 35, "FERTILIZER": 100}
_GLUT_WEIGHT = {"MELON": 3.5, "STRAWBERRY": 2.0, "MILK": 2.0, "WOOL": 3.2, "EGG": 1.0, "WHEAT": 1.0, "TOMATO": 1.0, "CARROT": 1.0, "FERTILIZER": 1.0}
_LAST_STEP = -1
_CLONE_CONFIDENCE = 0
...
def _front_run(action, obs, step):
    """Sell premium lines immediately before opponent's expected glut."""
    if _FRONT_RUN_HORIZON <= 0:
        return
    ...
    for item, (distance, quantity) in planned.items():
        ...
        priority = (
            ...
            + (_FRONT_RUN_HORIZON + 1 - distance) * _BASE_PRICE.get(item, 100)
        )
...
_LIFT = ('MELON', 'STRAWBERRY', 'MILK', 'WOOL')
...
_C94_OPENING = "feed5"
_C94_SPLIT_ITEMS = ('MELON', 'STRAWBERRY', 'MILK', 'WOOL', 'WHEAT', 'FERTILIZER', 'EGG')
_C94_SPLIT_CAPS = {'MELON': 20, 'STRAWBERRY': 20, 'MILK': 20, 'WOOL': 20, 'WHEAT': 10, 'FERTILIZER': 5, 'EGG': 10}
_C94_SPLIT_START = 24
_C94_SPLIT_STOP = 715
